...
require (
	...
	github.com/dogmatiq/example v0.0.0-20241005111935-66dfd1c45b34
	github.com/dogmatiq/ferrite v1.5.1
	github.com/dogmatiq/persistencekit v0.11.0
...
require (
	...
	github.com/dogmatiq/projectionkit v0.7.5 // indirect
