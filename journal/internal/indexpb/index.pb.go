...
// Commit contains information about the last journal record that was
// fully committed to the index.
type Commit struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// RecordId is the ID of the last journal record that was fully
	// committed to the index.
	RecordId              []byte `protobuf:"bytes,1,opt,name=record_id,json=recordId,proto3" json:"record_id,omitempty"`
	EventstreamNextOffset uint64 `protobuf:"varint,2,opt,name=eventstream_next_offset,json=eventstreamNextOffset,proto3" json:"eventstream_next_offset,omitempty"` // uint64 eventstream_offset_index_count = 3;
}
...
func (x *Commit) GetRecordId() []byte {
	if x != nil {
		return x.RecordId
	}
	return nil
...
func (x *Commit) GetEventstreamNextOffset() uint64 {
	if x != nil {
		return x.EventstreamNextOffset
	}
	return 0
}

// Queue contains the list of message IDs in the queue.
type Queue struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
// EventStreamOffset maps record IDs to event stream offsets.
type EventStreamOffset struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RecordId            []byte `protobuf:"bytes,1,opt,name=record_id,json=recordId,proto3" json:"record_id,omitempty"`
	FirstOffsetInRecord uint64 `protobuf:"varint,2,opt,name=first_offset_in_record,json=firstOffsetInRecord,proto3" json:"first_offset_in_record,omitempty"`
}

func (x *EventStreamOffset) Reset() {
	*x = EventStreamOffset{}
	if protoimpl.UnsafeEnabled {
...
func (x *EventStreamOffset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EventStreamOffset) ProtoMessage() {}

func (x *EventStreamOffset) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_dogmatiq_veracity_journal_internal_indexpb_index_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EventStreamOffset.ProtoReflect.Descriptor instead.
func (*EventStreamOffset) Descriptor() ([]byte, []int) {
	return file_github_com_dogmatiq_veracity_journal_internal_indexpb_index_proto_rawDescGZIP(), []int{2}
}

func (x *EventStreamOffset) GetRecordId() []byte {
	if x != nil {
		return x.RecordId
	}
	return nil
...
func (x *EventStreamOffset) GetFirstOffsetInRecord() uint64 {
	if x != nil {
		return x.FirstOffsetInRecord
	}
	return 0
}
...
var file_github_com_dogmatiq_veracity_journal_internal_indexpb_index_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x78, 0x2e, 0x76, 0x31, 0x22, 0x5d, 0x0a, 0x06, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x08, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x49, 0x64, 0x12, 0x36, 0x0a,
	0x17, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x5f, 0x6e, 0x65, 0x78,
	0x74, 0x5f, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x15,
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4e, 0x65, 0x78, 0x74, 0x4f,
	0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x28, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x75, 0x65, 0x12, 0x1f,
	...
	,
...
var file_github_com_dogmatiq_veracity_journal_internal_indexpb_index_proto_goTypes = []interface{}{
	(*Commit)(nil),            // 0: veracity.index.v1.Commit
	(*Queue)(nil),             // 1: veracity.index.v1.Queue
	(*EventStreamOffset)(nil), // 2: veracity.index.v1.EventStreamOffset
}
...
func file_github_com_dogmatiq_veracity_journal_internal_indexpb_index_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_dogmatiq_veracity_journal_internal_indexpb_index_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EventStreamOffset); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
