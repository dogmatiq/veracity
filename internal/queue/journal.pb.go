...
type EnqueueRecord struct {
	...
	Envelopes []*envelopespec.Envelope `protobuf:"bytes,1,rep,name=envelopes,proto3" json:"envelopes,omitempty"`
}
...
func (x *EnqueueRecord) GetEnvelopes() []*envelopespec.Envelope {
	if x != nil {
		return x.Envelopes
	}
	return nil
...
func (x *RejectRecord) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
var file_github_com_dogmatiq_veracity_internal_queue_journal_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf5, 0x01, 0x0a, 0x0d, 0x4a, 0x6f, 0x75,
	...
	0x36, 0x0a, 0x06, 0x72, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1c, 0x2e, 0x76, 0x65, 0x72, 0x61, 0x63, 0x69, 0x74, 0x79, 0x2e, 0x71, 0x75, 0x65, 0x75, 0x65,
	0x2e, 0x52, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x48, 0x00, 0x52,
	0x06, 0x72, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x42, 0x07, 0x0a, 0x05, 0x4f, 0x6e, 0x65, 0x4f, 0x66,
	0x22, 0x52, 0x0a, 0x0d, 0x45, 0x6e, 0x71, 0x75, 0x65, 0x75, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72,
	0x64, 0x12, 0x41, 0x0a, 0x09, 0x65, 0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x73, 0x18, 0x01,
	...
	0x6f, 0x70, 0x65, 0x73, 0x22, 0x2e, 0x0a, 0x0d, 0x41, 0x63, 0x71, 0x75, 0x69, 0x72, 0x65, 0x52,
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x49, 0x64, 0x22, 0x2a, 0x0a, 0x09, 0x41, 0x63, 0x6b, 0x52, 0x65, 0x63, 0x6f, 0x72,
	...
	0x22, 0x2d, 0x0a, 0x0c, 0x52, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64,
...
var file_github_com_dogmatiq_veracity_internal_queue_journal_proto_goTypes = []interface{}{
	...
	(*RejectRecord)(nil),          // 4: veracity.queue.RejectRecord
...
var file_github_com_dogmatiq_veracity_internal_queue_journal_proto_depIdxs = []int32{
	...
	4, // 3: veracity.queue.JournalRecord.reject:type_name -> veracity.queue.RejectRecord
	5, // 4: veracity.queue.EnqueueRecord.envelopes:type_name -> dogma.interop.v1.envelope.Envelope
