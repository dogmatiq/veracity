...
func file_github_com_dogmatiq_veracity_internal_eventstream_internal_eventstreamjournal_record_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_dogmatiq_veracity_internal_eventstream_internal_eventstreamjournal_record_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Record); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_dogmatiq_veracity_internal_eventstream_internal_eventstreamjournal_record_proto_msgTypes[1].Exporter = func(v any, i int) any {
