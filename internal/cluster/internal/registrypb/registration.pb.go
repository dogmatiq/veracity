...
var file_github_com_dogmatiq_veracity_internal_cluster_internal_registrypb_registration_proto_goTypes = []interface{}{
...
func file_github_com_dogmatiq_veracity_internal_cluster_internal_registrypb_registration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_dogmatiq_veracity_internal_cluster_internal_registrypb_registration_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_dogmatiq_veracity_internal_cluster_internal_registrypb_registration_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
