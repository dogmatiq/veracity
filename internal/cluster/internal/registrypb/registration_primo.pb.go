...
//
// It allows [*Node] to implement [encoding.BinaryMarshaler].
...
//
// It allows [*Node] to implement [encoding.BinaryUnmarshaler].
...
// calling proto.Marshal(x).
//
// It allows [*Registration] to implement [encoding.BinaryMarshaler].
func (x *Registration) MarshalBinary() ([]byte, error) {
	return proto.Marshal(x)
}
...
// calling proto.Unmarshal(data, x).
//
// It allows [*Registration] to implement [encoding.BinaryUnmarshaler].
func (x *Registration) UnmarshalBinary(data []byte) error {
	return proto.Unmarshal(data, x)
}
